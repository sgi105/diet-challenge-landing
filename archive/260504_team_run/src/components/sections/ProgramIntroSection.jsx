...
const features = [
  {
    icon: '🌐',
    title: '세계 최초 온라인 런클럽',
    desc: '오프라인 모임 0회. 집 앞 골목, 회사 옥상, 호텔 헬스장 어디서 뛰어도 OK. 앱 인증 + 댓글 응원으로 함께 뜁니다.',
  },
  {
    icon: '👥',
    title: '3인 1팀 × 10팀 게임',
    desc: '팀원이 오늘도 뛰었는데 나만 빠질 순 없습니다. 직전 기수 평균 수행률 95%, 의지력보다 강한 건 팀입니다.',
  },
  {
    icon: '💸',
    title: '100% 환급 시스템',
    desc: '20만원 보증금. 4주 미션 90% 완료하면 전액 환급. 실패하면 몰수 → 우승팀 상금 풀로.',
  },
  {
    icon: '🏆',
    title: '총 상금 168만원',
    desc: '우승팀(3명)은 1인당 40만원 환급 — 러닝화 가치. 팀 성공만 해도 +4만 보너스.',
  },
];
