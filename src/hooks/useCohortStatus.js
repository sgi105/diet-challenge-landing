...
export const COPY = {
  ...
  open: {
    banner: '🟢 시즌 1 신청 마감 5/28(목) 23:59 → 6/1(월) 시작',
    ctaSub: '5/28(목) 23:59 마감 · 2분 소요',
    cta: {
      hero: '지원하기',
      pricing: '지원하기',
      final: '지원하기',
    ...
    stickySub: '5/28(목) 23:59 마감',
  },
  closed: {
    banner: '⏰ 시즌 1 정원 30/30 마감 · 결원 대기 명단 →',
    cta: {
...
export const COPY_REFERRAL = {
  ...
  open: {
    banner: '🟧 초대 전용 · 5/28(목) 23:59 마감 · 추천인 이름 필수 →',
    ctaSub: '5/28(목) 23:59 마감 · 추천인 이름 입력 필수',
    cta: {
      hero: '초대 전형으로 지원하기',
