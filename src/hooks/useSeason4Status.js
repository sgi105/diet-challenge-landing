...
//   official — 모집 중 (8/19 08:00 ~ 8/21 14:30) · 선착순 30명 + 지원서 심사
//   closed   — 마감 (8/21 14:30~) · 결원 대기 명단
function compute() {
  const now = Date.now();
...
export const COPY4 = {
  ...
  official: {
    banner: '🔴 모집 중 · 8/21(금) 오후 2시 30분 마감 · 선착순 30명',
    ctaSub: '8/21(금) 오후 2시 30분 마감',
    cta: {
      hero: '지원하기',
      pricing: '지원하기',
      final: '지원하기',
