...
import { COHORT5, SCHEDULE5 } from '../../data/season5';
...
export default function UrgencySection() {
  ...
  const sub = isUpcoming
    ? `${COHORT5.openLabel} 오픈 · 선착순 30명`
    : `선착순 30명 · ${COHORT5.deadlineLabel} 마감`;
  const pill = isUpcoming ? 'OPENS SOON' : 'DEADLINE';

  const count = useApplicantCount(!isUpcoming, COHORT5.cohortCode);
