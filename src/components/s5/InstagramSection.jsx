...
// 260824_team_run 랜딩 fork. 누적 수치 = 앱 이전 9기 116명 + 2026-04 이후 팀 챌린지 7기 중복 제외 100명 (2026-09-15 DB 집계).
const photos = [
      ...
      <div className="px-6 max-w-lg mx-auto">
        <AnimateOnScroll>
          ...
          <p className="text-text-secondary mb-8 break-keep leading-relaxed">
            16기 동안 총 <span className="text-text-primary font-bold">216명</span>에게 검증된 구조 — <span className="text-text-primary font-bold">팀 + 경쟁(당근) + 보증금(채찍)</span>.
            <br />
