...
// 콘텐츠 Day3(소유) 기반 — 러닝을 게임으로: 팀·경쟁·보상 + 증거 + 후기 3축.
const pillars = [
  { icon: '👥', tag: '팀', title: '4인 1팀', desc: '매일 서로의 인증을 보고 댓글·응원. 혼자가 아니라 같이 뛴다.' },
  { icon: '📊', tag: '경쟁', title: '실시간 팀 대항전', desc: '러닝할 때마다 팀 점수가 쌓이고, 팀끼리 실시간 순위 경쟁.' },
  { icon: '🏆', tag: '보상', title: '1등 팀 러닝화', desc: '3주 경쟁 끝, 최종 1등 팀은 다 같이 축하하고 신상 러닝화까지.' },
];
