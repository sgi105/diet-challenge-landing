...
const pillars = [
  {
    icon: '🔒',
    title: '채찍 — 강제성',
    desc: '매일 인증 안 하면 보증금 깎여. 4명 1팀 — 한 명만 빠져도 팀 전체 보너스 소멸. 못 빠진다.',
  },
  {
    icon: '🥕',
    title: '당근 — 보상',
    desc: '팀 경쟁의 재미와 1등 팀은 전원 DARIMATI 러닝화(60만원)까지.',
  },
  {
    icon: '📈',
    title: '점진적 — 지속 가능',
    desc: 'Day1 1K부터 Day21 5K까지. 하루 최대 20분. 힘 안 들게 천천히 늘려서 끝까지 간다.',
  },
];
