...
const VARIANT_COPY = {
  main: {
    ...
    painPoints: [
      ...
      { icon: '🌧', text: '어제는 비, 그제는 회식 — 핑계는 무한 생성.' },
      { icon: '😶', text: '혼자 뛰면 5분 만에 "내가 왜 이걸 하지?" 해.' },
    ],
    why: '러닝이 안 되는 이유는 의지가 약해서가 아니야.',
    pairLabel: '같이 뛸 사람',
  },
  referral: {
    ...
    painPoints: [
      ...
      { icon: '🌧', text: '어제는 회식, 그제는 야근 — 핑계는 무한 생성.' },
      { icon: '😶', text: '혼자 운동하면 5분 만에 "내가 왜 이걸 하지?" 해.' },
    ],
    why: '운동·다이어트가 안 되는 이유는 의지가 약해서가 아니야.',
    pairLabel: '같이 할 사람',
  },
};
